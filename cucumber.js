// Cucumber-js config for the Varbase AI varbase-e2e suite.
//
// Runs the Drupal Standard profile feature set (Olivero front end, Claro
// admin theme) under tests/features/drupal/, against a site provisioned with
// the AI Core + ECA + AI Integration - ECA modules (the payload of the Varbase
// AI default recipe).
//
//   npx cucumber-js --config cucumber.js
//
// Reusable step definitions ship with varbase-e2e; the module-specific steps
// live in tests/step-definitions/varbase_ai.steps.js. Every worldParameter
